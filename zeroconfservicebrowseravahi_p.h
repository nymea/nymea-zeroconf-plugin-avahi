...
#ifndef ZEROCONFSERVICEBROWSERAVAHI_P_H
#define ZEROCONFSERVICEBROWSERAVAHI_P_H
...
{
public:
    ZeroConfServiceBrowserAvahiPrivate(QtAvahiClient *client);
    ~ZeroConfServiceBrowserAvahiPrivate();
